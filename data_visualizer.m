classdef data_visualizer < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function run_visualizer(app, event)
            ...
            save('checkbox_states.mat', "axis_values");
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            if isfile('checkbox_states.mat') % Check if file exists
                loadedData = load('checkbox_states.mat', 'axis_values'); % Load data
