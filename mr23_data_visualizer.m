classdef mr23_data_visualizer < matlab.apps.AppBase

    % Properties that correspond to app components
    properties (Access = public)
        PUBLIC_VER = 'v1.2.0';
        PRIVATE_VER = 'dev-25.03.21.1';
    ...
    methods (Access = private)
        ...
        function run_visualizer(app, event)
            ...
            if get(app.reformat_file_check, 'Value') == 1
                ...
                relevant_vars = fileread('mr23_app_resources/variables_relevant.txt');
            ...
            checkbox_vars = fileread('mr23_app_resources/variables_checkbox.txt');
            ...
            save('mr23_app_resources/checkbox_states.mat', "axis_values");
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            if isfile('mr23_app_resources/checkbox_states.mat') % Check if file exists
                loadedData = load('mr23_app_resources/checkbox_states.mat', 'axis_values'); % Load data
            ...
            app.Image.ImageSource = fullfile(pathToMLAPP, 'mr23_app_resources', 'background.png');
            ...
            app.mracing_logo.ImageSource = fullfile(pathToMLAPP, 'mr23_app_resources', 'mracing_logo.png');
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = mr23_data_visualizer
